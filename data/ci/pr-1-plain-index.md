...
|---|---|---|---|---|---|---|
| `007_index_orders_status.sql` | FAIL | 4.1 s | ok: completed | ok: no app query failed | **fail**: worst write 3733 ms, worst read 137 ms (limit 1000 ms) | ok: no table lost rows |

<details><summary>Schema diff: 007_index_orders_status.sql</summary>

```diff
--- Database: neondb	(Branch: br-ancient-salad-b2vntgbd)
+++ Database: neondb	(Branch: br-sweet-sun-b2i4hcqe)
@@ -124,8 +124,15 @@
