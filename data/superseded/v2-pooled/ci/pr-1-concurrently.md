...
|---|---|---|---|---|---|---|
| `007_index_orders_status.sql` | PASS | 4.1 s | ok: completed | ok: no app query failed | ok: worst write 206 ms, worst read 163 ms (limit 1000 ms) | ok: no table lost rows |

<details><summary>Schema diff: 007_index_orders_status.sql</summary>

```diff
--- Database: neondb	(Branch: br-ancient-salad-b2vntgbd)
+++ Database: neondb	(Branch: br-solitary-dust-b2nv5i0u)
@@ -124,8 +124,15 @@
