...
1 of 1 passed. Blocking limit: 1000 ms.

| Migration | Result | Ran for | Runs | Blocking | Rows |
|---|---|---|---|---|---|
| `007_index_orders_status.sql` | PASS | 4.1 s | ok: completed | ok: worst write 136 ms, worst read 107 ms (limit 1000 ms) | ok: no table lost rows |

<details><summary>Schema diff: 007_index_orders_status.sql</summary>

```diff
--- Database: neondb	(Branch: br-ancient-salad-b2vntgbd)
+++ Database: neondb	(Branch: br-patient-leaf-b247apzp)
@@ -124,8 +124,15 @@
